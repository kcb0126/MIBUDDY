...
public class ChineseQuestion implements Parcelable {
    ...
    public boolean readQuestionsCategory(Context context, String category){
        ...
        cursor = db.query(
                DataBaseContract.DataBaseEntry.TABLE_NAME_CHINESE_QUESTION, // tabla
                projection, // columnas
                selection, // where
    ...
    protected ChineseQuestion(Parcel in) {
    ...
    public static final Creator<ChineseQuestion> CREATOR = new Creator<ChineseQuestion>() {
        @Override
